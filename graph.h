...
public:
    ...
    vector<Vertex> getIncomingVertices(Vertex source) const; 

    virtual int getId(Vertex vertex) const;
...
private:
    ...
    mutable unordered_map<Vertex, vector<Vertex>> in_adjacency_list; 
